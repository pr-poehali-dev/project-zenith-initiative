  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Fourway создали для нас нечто большее, чем здание. Это пространство, которое живёт и развивается вместе с нашим бизнесом. Классический подход и смелые решения — именно такой баланс мы искали.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">James & Patricia Holloway</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Корпоративный кампус, Atlanta</p>
        </div>
      </div>
    </section>
  )
