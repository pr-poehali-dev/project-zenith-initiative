      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:pl-8">
            ...
            >
              Форма следует
              <span className="italic"> за жизнью</span>
            </h2>
            ...
            >
              <p>
                Мы убеждены: хорошая архитектура не навязывает образ жизни, а точно отвечает на него.
                Каждый проект начинается с глубокого понимания человека, который будет в нём существовать.
              </p>
              <p>
                В основе нашего подхода — принцип <em className="text-foreground">ма</em>: значение
                пространства рождается не из заполненности, а из правильно найденной пустоты. Мы
                проектируем то, что остаётся, когда убрано лишнее.
              </p>
            </div>
