      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:pl-8">
            ...
            >
              Традиции как
              <span className="italic"> фундамент инноваций</span>
            </h2>
            ...
            >
              <p>
                В 2024 году в Атланте наши основатели — ветераны архитектурной отрасли — собрались на перекрёстке четырёх ключевых дорог: классических практик, современных технологий, экологичных материалов и клиент-центричного дизайна.
              </p>
              <p>
                Мы убеждены: лучшая архитектура рождается там, где уважение к проверенным принципам
                встречается с <em className="text-foreground">смелостью новых идей</em>. Каждый наш проект
                открывает клиенту новые горизонты, оставаясь при этом надёжным и реализуемым.
              </p>
            </div>
