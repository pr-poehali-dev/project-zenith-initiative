...
const steps = [
  {
    ...
    title: "Знакомство",
    description:
      "Начинаем с разговора о вас: кто вы, как живёте, что важно. Понимание человека — фундамент любого нашего проекта.",
  },
  {
    number: "02",
    title: "Концепция",
    description:
      "Разрабатываем авторскую идею пространства. Эскизы, образы, материалы — всё складывается в единый архитектурный образ.",
  },
  {
    number: "03",
    title: "Проектирование",
    description:
      "Переводим концепцию в точные чертежи и документацию. Каждое решение аргументировано и выверено до миллиметра.",
  },
  {
    number: "04",
    title: "Реализация",
    description:
      "Ведём авторский надзор на всех этапах строительства. Проект остаётся нашей ответственностью до финальной точки.",
  },
]
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-4">
            <div className="lg:sticky lg:top-32">
              ...
              >
                Путь
                <span className="italic"> к проекту</span>
              </h2>
              <p
              ...
              >
                Хорошая архитектура требует времени и диалога. Мы работаем поэтапно — чтобы каждое решение
                было выверено, а итоговый объект точно отвечал вашей жизни.
              </p>
            </div>
          </div>
